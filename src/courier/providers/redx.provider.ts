...
export class RedxProvider implements CourierProviderInterface {
  ...
  constructor(
    ...
    this.baseUrl = this.configService.get(
      'REDX_API_URL',
      'https://portal.redx.com.bd/api/v1',
    );
    this.apiKey = this.configService.get('REDX_API_KEY');
    this.secretKey = this.configService.get('REDX_SECRET_KEY');
  }
  ...
  async createShipment(data: any): Promise<any> {
    try {
      ...
      return {
        ...
        trackingUrl: `https://redx.com.bd/t/${response.data.tracking_code}`,
