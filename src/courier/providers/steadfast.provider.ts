...
@Injectable()
export class SteadfastCourierProvider implements CourierProviderInterface {
  ...
  constructor(
    ...
    this.apiKey = this.configService.get('STEADFAST_API_KEY');
    this.secretKey = this.configService.get('STEADFAST_SECRET_KEY');
  }
  ...
  async createShipment(data: any): Promise<any> {
    try {
      ...
      return {
        ...
        trackingUrl: `https://steadfast.com.bd/t/${response.data.tracking_code}`,
