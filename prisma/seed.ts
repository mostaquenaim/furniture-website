          ...
          subCategories: [
            {
              ...
              slug: 'leather-sofas',
              image:
                'https://example.com/images/subcategories/leather-sofas.jpg',
              sortOrder: 1,
              isActive: true,
              products: [
                {
            ...
            },
            {
              ...
              slug: 'fabric-sofas',
              image:
                'https://example.com/images/subcategories/fabric-sofas.jpg',
              sortOrder: 2,
              isActive: true,
              products: [
                {
          ...
          subCategories: [
            {
              ...
              image:
                'https://example.com/images/subcategories/wooden-coffee-tables.jpg',
              sortOrder: 1,
              isActive: true,
              products: [
                {
          ...
          subCategories: [
            {
              ...
              image:
                'https://example.com/images/subcategories/modern-tv-stands.jpg',
              sortOrder: 1,
              isActive: true,
              products: [
                {
          ...
          subCategories: [
            {
              ...
              slug: 'king-size-beds',
              image:
                'https://example.com/images/subcategories/king-size-beds.jpg',
              sortOrder: 1,
              isActive: true,
              products: [
                {
            ...
            },
            {
              ...
              image:
                'https://example.com/images/subcategories/queen-size-beds.jpg',
              sortOrder: 2,
              isActive: true,
              products: [
                {
          ...
          subCategories: [
            {
              ...
              image:
                'https://example.com/images/subcategories/sliding-wardrobes.jpg',
              sortOrder: 1,
              isActive: true,
              products: [
                {
          ...
          subCategories: [
            {
              ...
              image:
                'https://example.com/images/subcategories/modular-kitchen.jpg',
              sortOrder: 1,
              isActive: true,
              products: [
                {
          ...
          subCategories: [
            {
              ...
              image:
                'https://example.com/images/subcategories/wooden-dining-tables.jpg',
              sortOrder: 1,
              isActive: true,
              products: [
                {
          ...
          subCategories: [
            {
              ...
              image:
                'https://example.com/images/subcategories/executive-desks.jpg',
              sortOrder: 1,
              isActive: true,
              products: [
                {
          ...
          subCategories: [
            {
              ...
              image:
                'https://example.com/images/subcategories/ergonomic-chairs.jpg',
              sortOrder: 1,
              isActive: true,
              products: [
                {
          ...
          subCategories: [
            {
              ...
              slug: 'outdoor-sofas',
              image:
                'https://example.com/images/subcategories/outdoor-sofas.jpg',
              sortOrder: 1,
              isActive: true,
              products: [
                {
          ...
          subCategories: [
            {
              ...
              slug: 'wall-shelves',
              image:
                'https://example.com/images/subcategories/wall-shelves.jpg',
              sortOrder: 1,
              isActive: true,
              products: [
                {
          ...
          subCategories: [
            {
              ...
              image:
                'https://example.com/images/subcategories/canvas-paintings.jpg',
              sortOrder: 1,
              isActive: true,
              products: [
                {
          ...
          subCategories: [
            {
              ...
              image:
                'https://example.com/images/subcategories/bathroom-vanities.jpg',
              sortOrder: 1,
              isActive: true,
              products: [
                {
          ...
          subCategories: [
            {
              ...
              slug: 'media-consoles',
              image:
                'https://example.com/images/subcategories/media-consoles.jpg',
              sortOrder: 1,
              isActive: true,
              products: [
                {
